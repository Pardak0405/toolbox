  ...
  const faqs = [
    {
      ...
      a: "핵심 브라우저 기능은 무료로 제공합니다. 일부 고급 변환은 로컬 엔진 환경에 따라 품질 차이가 있습니다."
    },
    {
      q: "파일이 서버로 업로드되나요?",
    ...
    {
      q: "로컬 엔진은 언제 사용하나요?",
      a: "오피스 문서 고정밀 변환이나 대용량 변환처럼 브라우저 한계를 넘는 작업에서 사용합니다."
    },
    {
      q: "광고는 어디에 표시되나요?",
    ...
    },
    {
      ...
      a: "옵션(품질/해상도/페이지 범위)을 먼저 조정하고, 필요하면 로컬 엔진 모드로 재시도하는 것을 권장합니다."
    },
    {
      q: "문의는 어디로 보내나요?",
